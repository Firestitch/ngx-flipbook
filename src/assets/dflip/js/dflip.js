...
(function dFlip(DFLIP, $) {
    ...
    var defaults = DFLIP.defaults = {
        ...
        cMapUrl: "assets/dflip/cmaps/", //it's quite wierd how cmaps don't work properly with relative urls like others.. but is relative to pdf.min.js path
...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        if (typeof dFlipLocation == 'undefined' && DFLIP.autoDetectLocation != false) {
            $("script").each(function () {
                ...
                if ((src.indexOf("/dflip.js") > -1 || src.indexOf("/dflip.min.js") > -1 )
                    && (src.indexOf("https://") > -1 || src.indexOf("http://") > -1 ) && src.indexOf("assets/dflip/js/dflip.") > -1) {
        ...
        if (typeof dFlipLocation !== 'undefined') {
            ...
            DFLIP.defaults.mockupjsSrc = dFlipLocation + "assets/dflip/js/libs/mockup.min.js";
            DFLIP.defaults.pdfjsSrc = dFlipLocation + "assets/dflip/js/libs/pdf.min.js";
            DFLIP.defaults.pdfjsCompatibilitySrc = dFlipLocation + "assets/dflip/js/libs/compatibility.js";
            DFLIP.defaults.threejsSrc = dFlipLocation + "assets/dflip/js/libs/three.min.js";
            DFLIP.defaults.pdfjsWorkerSrc = dFlipLocation + "assets/dflip/js/libs/pdf.worker.min.js";
            DFLIP.defaults.soundFile = dFlipLocation + "assets/dflip/sound/turn2.mp3";
            DFLIP.defaults.imagesLocation = dFlipLocation + "assets/dflip/images";
            DFLIP.defaults.imageResourcesPath = dFlipLocation + "assets/dflip/images/pdfjs/";
            DFLIP.defaults.cMapUrl = dFlipLocation + "assets/dflip/js/libs/cmaps/";
